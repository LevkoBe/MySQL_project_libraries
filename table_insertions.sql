...
INSERT INTO books (isbn, title, edition, year_published, price, pages, genre_id, publisher_id, author_id, reviews, rating, status) VALUES
('9780590353427', "Harry Potter and the Philosopher\'s Stone", 1, 1997, 10.99, 320, 1, 1, 1, 10000, 4.7, 'Available'),
('9780439064866', 'Harry Potter and the Chamber of Secrets', 1, 1998, 11.99, 352, 1, 1, 1, 9500, 4.6, 'Available'),
('9780439136365', 'Harry Potter and the Prisoner of Azkaban', 1, 1999, 12.99, 448, 1, 1, 1, 9200, 4.8, 'Available'),
('9780439139601', 'Harry Potter and the Goblet of Fire', 1, 2000, 13.99, 640, 1, 1, 1, 8700, 4.9, 'Available'),
('9780439358071', 'Harry Potter and the Order of the Phoenix', 1, 2003, 14.99, 896, 1, 1, 1, 8500, 4.8, 'Available'),
('9780439784542', 'Harry Potter and the Half-Blood Prince', 1, 2005, 15.99, 672, 1, 1, 1, 8200, 4.8, 'Available'),
('9780545010221', 'Harry Potter and the Deathly Hallows', 1, 2007, 16.99, 784, 1, 1, 1, 8100, 4.9, 'Available'),
('9781501175466', 'The Shining', 1, 1977, 9.99, 688, 7, 2, 2, 9500, 4.5, 'Available'),
('9780307743657', 'The Stand', 1, 1978, 10.99, 1152, 7, 2, 2, 9200, 4.6, 'Available'),
('9780451169532', 'Misery', 1, 1987, 11.99, 368, 7, 2, 2, 8900, 4.7, 'Available'),
('9781501166273', 'It', 1, 1986, 12.99, 1168, 7, 2, 2, 8600, 4.8, 'Available'),
('9781501142970', 'The Girl on the Train', 1, 2015, 13.99, 336, 2, 3, 3, 9300, 4.4, 'Available'),
('9781594634024', 'Gone Girl', 1, 2012, 14.99, 432, 2, 3, 3, 9200, 4.5, 'Available'),
('9780385349956', 'The Da Vinci Code', 1, 2003, 15.99, 592, 2, 3, 3, 9000, 4.6, 'Available'),
('9780062315007', 'Crazy Rich Asians', 1, 2013, 16.99, 544, 3, 4, 4, 9500, 4.3, 'Available'),
('9780525555713', 'The Hating Game', 1, 2016, 17.99, 384, 3, 4, 4, 9400, 4.4, 'Available'),
('9780345535527', 'The Notebook', 1, 1996, 18.99, 256, 3, 4, 4, 9100, 4.5, 'Available'),
('9780143135169', 'The Silent Patient', 1, 2019, 19.99, 352, 7, 5, 5, 9600, 4.2, 'Available'),
('9780446675536', 'Big Little Lies', 1, 2014, 20.99, 480, 7, 5, 5, 9500, 4.3, 'Available'),
('9781538718466', 'The Woman in the Window', 1, 2018, 21.99, 448, 7, 5, 5, 9400, 4.4, 'Available'),
('9781982123966', 'The Night Circus', 1, 2011, 22.99, 512, 4, 6, 6, 9300, 4.1, 'Available'),
('9780062073459', 'The Starless Sea', 1, 2019, 23.99, 512, 4, 6, 6, 9200, 4.2, 'Available'),
('9780061854149', 'Neverwhere', 1, 1996, 24.99, 448, 4, 6, 6, 9000, 4.3, 'Available'),
('9780385472579', 'The Testaments', 1, 2019, 25.99, 432, 14, 7, 7, 9900, 4.0, 'Available'),
('9780525559063', "The Handmaid's Tale", 1, 1985, 26.99, 311, 14, 7, 7, 9800, 4.1, 'Available'),
('9781444767465', 'The Blind Assassin', 1, 2000, 27.99, 637, 14, 7, 7, 9700, 4.2, 'Available'),
('9780062273092', 'American Gods', 1, 2001, 28.99, 635, 6, 1, 6, 9500, 4.0, 'Available'),
('9780062457738', 'Norse Mythology', 1, 2017, 29.99, 304, 6, 1, 6, 9400, 4.1, 'Available'),
('9780060735273', 'Stardust', 1, 1999, 30.99, 288, 6, 1, 6, 9300, 4.2, 'Available'),
('9780385671753', 'Oryx and Crake', 1, 2003, 31.99, 374, 6, 1, 6, 9200, 4.3, 'Available'),
('9780385475723', "Cat's Eye", 1, 1988, 32.99, 446, 6, 1, 6, 9100, 4.4, 'Available'),
('9780385544337', 'The Testaments', 1, 2019, 33.99, 432, 14, 1, 7, 9000, 4.5, 'Available'),
('9780385544290', "The Handmaid's Tale", 1, 1985, 34.99, 311, 14, 1, 7, 8900, 4.6, 'Available'),
('9780385653453', 'The Blind Assassin', 1, 2000, 35.99, 637, 14, 1, 7, 8800, 4.7, 'Available');

SELECT * FROM books;

INSERT INTO loans (customer_id, book_ids) VALUES
(1, '1'),
(1, '2'),
(2, '31'),
(3, '23'),
